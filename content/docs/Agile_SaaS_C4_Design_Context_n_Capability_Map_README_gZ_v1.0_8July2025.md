...
1. **System Context Diagram (C4 Level 1)**:
   ...
   * Shows *external context*—users, external systems, high-level purpose.
   * Focus: **Business context & external dependencies.**

2. **Container Diagram (C4 Level 2)**:

   * Shows *internal technical containers*—apps, APIs, services, DBs.
...
* Teams need a **single document** that captures:
  ...
  * *External Context* → “Where do we fit?”
  * *Key Internal Capabilities* → “What can we do and how?”
...
In *very large*, highly regulated systems (e.g., banking cores), you may want to **keep them separate** for compliance, security, or legal reasons.
